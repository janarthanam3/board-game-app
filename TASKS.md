...
- [ ] **C7 | GATE: engine verified** | depends-on: C5, C5a, C6 | files: — | acceptance: ≥ 90% coverage; every edge-case row in `docs/05-game-rules.md` has a passing test; fuzz run of 1,000 seeded matches holds cash conservation and no negative state; two replays of one seed are byte-identical | tests: the property/fuzz suite | effort: 1
